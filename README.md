...
* **JavaScript** — Handling the dynamic interactions and behaviors.
...
* ✔️ **Static Front-End**: The front-end is functional and allows users to access content.
* ❌ **No Backend**: There is no server or database integration.
* ❌ **No Login System**: User authentication (login/signup) and roles (student/teacher/admin) are not implemented.
* ❌ **Manual Course Content**: Courses and content need to be manually added.
